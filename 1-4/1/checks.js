...
var result = lib.query(
    friends,
    lib.select('name', 'gender', 'milk'),
    lib.select('name', 'gender','email', 'milk', 'email'),
    lib.select('email', 'gender','milk', 'email'),
    lib.select('email', 'gender','milk', 'email'),
    lib.select('email', 'milk', 'email'),
    lib.filterIn('name', ['Стелла', 'Керри']),
